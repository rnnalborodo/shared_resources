...
public class ArrayList implements List {
  ...
  private static class ArrayListIterator implements ListIterator {
    ...
    /*@ private invariant arrayList.\inv;
	  ...
	  @ private invariant \typeof(arrayList) == es.upm.babel.ccjml.samples.csp.list.src.ArrayList;
	  @*/

    /*@ public normal_behaviour
	  @   requires l.\inv && \typeof(l) == es.upm.babel.ccjml.samples.csp.list.src.ArrayList;
	  @   ensures list == l;
	  @   ensures pos == 0; 
	  @*/
