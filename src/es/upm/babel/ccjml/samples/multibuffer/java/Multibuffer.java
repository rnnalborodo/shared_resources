...
/**
 * A variation of a producer-consumer problem using a bounded 
 * buffer in which Producers add new items to the buffer 
 * whilst consumers get and remove a given number of items.
 *
 * @author BABEL Group
 */
